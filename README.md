...
# Contributers
Starter code provided by Bootcamp, trouble shooting for date time and errors assisted through Expert Learning Assistant. Code completed by Lauren Graves.

# Files
Deliverable 1: A Jupyter notebook containing code that imports the data and sets up and updates the uk_food database. Labeled "NoSQL_setup".

Deliverable 2: A Jupyter notebook containing code that performs the exploratory analysis queries in the database. Labeled "NoSQL_analysis".

The "Resources" file contains the JSON used to extract information and analyze. 
